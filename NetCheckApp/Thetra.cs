...
namespace Core.NetChecker {
    ...
    /// </summary>
    public class Thetra {
        public Thetra(int _a, int _b, int _c, int _d, int _mat) { p[0] = _a; p[1] = _b; p[2] = _c; p[3] = _d; material = _mat; }
        ...
        public Thetra(string[] s) { p[0] = Convert.ToInt32(s[0]); p[1] = Convert.ToInt32(s[1]); p[2] = Convert.ToInt32(s[2]); p[3] = Convert.ToInt32(s[3]); material = Convert.ToInt32(s[4]); }
